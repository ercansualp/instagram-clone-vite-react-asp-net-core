...
export const CommentIcon = (props: props) => {
    ...
    return <svg style={style} aria-label="Yorum Yap" className={className} fill="currentColor" height={height} role="img" viewBox="0 0 24 24" width={width}><title>Yorum Yap</title><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="2"></path></svg>
}

export const SavePostIcon = (props: props) => {
    const { width, height, className = "", style = {} } = props;

    return <svg style={style} aria-label="Kaydet" className={className} fill="currentColor" height={height} role="img" viewBox="0 0 24 24" width={width}><title>Kaydet</title><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></polygon></svg>
}
...
export const SavedPostsIcon = (props: props) => {
    ...
    return <svg style={style} aria-label="" className={className} fill="currentColor" height={height} role="img" viewBox="0 0 24 24" width={width}><title></title><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></polygon></svg>
}
...
export const FeedIcon = (props: props) => {
    ...
    return <svg style={style} aria-label="Akış" className={className} fill="currentColor" height={height} role="img" viewBox="0 0 24 24" width={width}><title>Akış</title><rect fill="none" height="10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" width="12" x="6" y="7"></rect><line fill="none" stroke="currentColor" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="2" x1="6.002" x2="18" y1="3.004" y2="3.004"></line><line fill="none" stroke="currentColor" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="2" x1="6.002" x2="18" y1="21" y2="21"></line></svg>
}
...
export const OtherOptionsIcon = (props: props) => {
    const { width, height, className = "", style = {} } = props;

    return <svg style={style} aria-label="Diğer seçenekler" className={className} fill="currentColor" height={height} role="img" viewBox="0 0 24 24" width={width}><title>Diğer seçenekler</title><circle cx="12" cy="12" r="1.5"></circle><circle cx="6" cy="12" r="1.5"></circle><circle cx="18" cy="12" r="1.5"></circle></svg>
}

export const NewMessageIcon = (props: props) => {
    const { width, height, className = "", style = {} } = props;

    return <svg style={style} aria-label="Yeni Mesaj" className={className} fill="currentColor" height={height} role="img" viewBox="0 0 24 24" width={width}><title>Yeni Mesaj</title><path d="M12.202 3.203H5.25a3 3 0 0 0-3 3V18.75a3 3 0 0 0 3 3h12.547a3 3 0 0 0 3-3v-6.952" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path><path d="M10.002 17.226H6.774v-3.228L18.607 2.165a1.417 1.417 0 0 1 2.004 0l1.224 1.225a1.417 1.417 0 0 1 0 2.004Z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path><line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="16.848" x2="20.076" y1="3.924" y2="7.153"></line></svg>
}

export const BackArrowIcon2 = (props: props) => {
    const { width, height, className = "", style = {} } = props;

    return <svg width={width} height={height} style={style} aria-label="Geri" className={className} fill="currentColor" role="img" viewBox="0 0 24 24"><title>Geri</title><line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="2.909" x2="22.001" y1="12.004" y2="12.004"></line><polyline fill="none" points="9.276 4.726 2.001 12.004 9.276 19.274" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></polyline></svg>
}
